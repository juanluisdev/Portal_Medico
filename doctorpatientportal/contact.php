...
<head>
	...
	<title>Contate nós - Portal do Medico</title>
				...
				<ul class="nav navbar-nav pull-right">
					...
					<?php if ($type == "admin") { ?>
						<li class="a"><a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Olá <?php echo $user ?>
								<span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="adminpanel.php"><span class="glyphicon glyphicon-th-list"></span> Seu perfil</a></li>
								<li role="separator" class="divider"></li>
								<li><a href="logout.php"><span class="glyphicon glyphicon-off"></span> Logout</a></li>
							</ul>
	...
	<div class="container">
		<div style="float:left; margin-left:-1.2%;width:102.5%;" class="jumbotron">
			<div style="box-shadow:2px 2px 5px grey; margin-top:-3%;" class="alert alert-info">
				...
				Tentaremos entrar em contato com você dentro de 24 horas. Por favor, insira um e-mail válido, pois não poderemos entrar em contato com você
			</div>
			<div class="well">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div style="background:#005173; color:white;" class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-user"></span> Entrar no Portal</h4>
				</div>
	...
	<div class="modal fade" id="register" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div style="background:#005173; color:white;" class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span style="color:white;" aria-hidden="true">&times;</span></button>
					<h4 class="modal-title" id="myModalLabel2"><span class="glyphicon glyphicon-saved" aria-hidden="true"></span> Registrar no Portal</h4>
				</div>
				<div class="modal-body">
