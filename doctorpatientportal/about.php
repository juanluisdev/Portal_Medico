...
<head>
	...
	<title>Sobre Nós - Portal do Medico</title>
...
<body>
		...
		<div style="padding:25px; border-top-left-radius:0.5em; border-top-right-radius:0.5em;" class="mainmenu container nav navbar-inverse" data-spy="affix" data-offset-top="100">
			...
			<div class="collapse navbar-collapse" id="coo">
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="active"><a href="about.php"><span class="glyphicon glyphicon-info-sign"></span> Sobre</a></li>
	...
	<div class="container">
		<div style="float:left; margin-left:-1.2%;width:102.5%;" class="jumbotron">
			...
			<center>
				<p class="well" style="width:80%;font-family:calibri;text-align:justify;">
					<b>Sobre o Portal :</b>
					O Portal Médico Paciente é um portal básico que auxilia os pacientes que ficam horas na fila para marcar consultas médicas em clínicas ou hospitais.
					Este portal ajuda a reduzir filas em hospitais. um cadastro simples, gratuito e vitalício para médico e paciente. Médicos verificados e de boa reputação tornam nosso portal mais confiável. Oferecemos serviços gratuitos, como painel próprio para gerenciar compromissos e outras coisas. Um sistema de mensagens pessoais que ajuda a receber conselhos de precauções do médico ou para outras conversas sobre saúde. É também uma mudança na Índia digital para diminuir o trabalho em papel e trabalhar digitalmente.
				</p>
			</center>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div style="background:#005173; color:white;" class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-user"></span> Login Portal</h4>
				</div>
	...
	<div class="modal fade" id="register" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div style="background:#005173; color:white;" class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span style="color:white;" aria-hidden="true">&times;</span></button>
					<h4 class="modal-title" id="myModalLabel2"><span class="glyphicon glyphicon-saved" aria-hidden="true"></span> Registro para portal</h4>
				</div>
				<div class="modal-body">
