...
<head>
	...
	<title>Ajuda - Portal do Medico</title>
		...
		<div style="padding:25px; border-top-left-radius:0.5em; border-top-right-radius:0.5em;" class="mainmenu container nav navbar-inverse" data-spy="affix" data-offset-top="100">
			...
			<div class="collapse navbar-collapse" id="coo">
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="active"><a href="help.php"><span class="glyphicon glyphicon-question-sign"></span> Ajuda</a></li>
				...
				<ul class="nav navbar-nav pull-right">
					...
					<?php if ($type == "doc") { ?>
						<li class="a"><a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Olá <?php echo $user ?>
							...
							<ul class="dropdown-menu">
								<li><a data-toggle="modal" data-target="#profiletab" href="#"><span class="glyphicon glyphicon-pencil"></span> Seu Perfil</a></li>
					...
					<?php if ($type == "pat") { ?>
						<li class="a"><a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Hi <?php echo $user ?>
								<span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a data-toggle="modal" data-target="#profiletab2"><span class="glyphicon glyphicon-pencil"></span> Seu Perfil</a></li>
								<li role="separator" class="divider"></li>
				...
				<div class="panel-heading" role="tab" id="headingOne">
					<h4 class="panel-title">
						<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
							<span class="glyphicon glyphicon-question-sign"></span> Como registrar?
						</a>
					</h4>
				</div>
				<div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body">
						Basta clicar naquele verde <span style="background:#059216; border-radius: 2em;color:white; padding:15px;">Regitro</span> botão e simplesmente registre-se em nosso site.
					</div>
				</div>
			</div>
			<br>
				...
				<div class="panel-heading" role="tab" id="headingTwo">
					<h4 class="panel-title">
						<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
							<span class="glyphicon glyphicon-question-sign"></span> Quantos dias leva para verificar a conta do médico?
						</a>
					</h4>
				</div>
				<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
					<div class="panel-body">
						Depende do nosso painel de administração quantos dias eles levam para revisar sua conta, mas o mínimo de dias para verificação da conta é de 2 a 3 dias.
					</div>
				</div>
			</div>
			<br>
				...
				<div class="panel-heading" role="tab" id="headingThree">
					<h4 class="panel-title">
						<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
							<span class="glyphicon glyphicon-question-sign"></span> Como marcar consulta?
						</a>
					</h4>
				</div>
				<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
					<div class="panel-body">
						Vá para o painel do paciente e clique na guia marcar consulta e marque consulta com o médico. você também pode marcar consulta clicando em cima do seu nome e no menu suspenso clicar em Quick Doctor List e marcar consulta
					</div>
				</div>
			</div>
			<br>
				...
				<div class="panel-heading" role="tab" id="headingThree">
					<h4 class="panel-title">
						<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapsefour" aria-expanded="false" aria-controls="collapseThree">
							<span class="glyphicon glyphicon-question-sign"></span> Como fazer o pagamento?
						</a>
					</h4>
				</div>
				<div id="collapsefour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
					<div class="panel-body">
						Ao enviar sua consulta você será redirecionado para a plataforma de pagamento onde inserirá seus dados para efetuar o pagamento.
					</div>
				</div>
			</div>
			<br>
				...
				<div class="panel-heading" role="tab" id="headingThree">
					<h4 class="panel-title">
						<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapsefive" aria-expanded="false" aria-controls="collapseThree">
							<span class="glyphicon glyphicon-question-sign"></span> Condição de reembolso se a consulta for perdida?
						</a>
					</h4>
				</div>
				<div id="collapsefive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
					<div class="panel-body">
						Não há condição de reembolso se você perder algum compromisso
					</div>
				</div>
			</div>
		</div>
